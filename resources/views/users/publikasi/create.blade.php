...
@section('header', 'Tambah Data Publikasi Baru')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
    @include('components.notification')
    <form method="POST" action="{{ route('publikasi.store') }}" enctype="multipart/form-data" class="space-y-6" x-data="{ mahasiswa: false }">
        @csrf
        <div>
        ...
        <div class="space-y-2 border-t pt-4">
             <div class="flex items-center space-x-2">
                ...
                <label for="kesesuaian_roadmap" class="text-sm text-gray-700">Sesuai Roadmap</label>
            </div>
             <div class="flex items-center space-x-2">
