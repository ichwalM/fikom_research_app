...
@section('content')
    ...
    <section class="py-20 bg-dark-charcoal">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                ...
                <div class="fade-in">
                    <div class="text-5xl font-bold text-golden-orange mb-2">{{ $jumlahPublikasi }}+</div>
                    <div class="text-xl text-off-white">Publikasi Ilmiah</div>
                </div>
                <div class="fade-in">
                    <div class="text-5xl font-bold text-golden-orange mb-2">{{ $jumlahPeneliti }}+</div>
    ...
    @include('public.components.dosenSection')
